...
// https://github.com/tryWabbit/Layout-Helper/blob/master/Layout%20Helper/Layout%20Helper/NSLayoutHelper.swift
...
@IBDesignable class NSLayoutHelper : NSLayoutConstraint {
    ...
    @IBInspectable var iPadPro11: CGFloat = 0.0 {
        didSet { deviceConstant(.i11Inch,value:iPadPro11) }
    }
